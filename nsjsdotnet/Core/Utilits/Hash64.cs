namespace nsjsdotnet.Core.Utilits
{
    ...
    {
        private static readonly ulong[] s_CRC64Table = new ulong[256]
        {
        ...
        public static long GetHashCode(byte[] data)
        {
            ...
            return unchecked((long)(crc ^ 0xffffffffffffffff));
        }
        ...
        public static long GetHashCode(string s)
        {
            ...
            byte[] buffer = Encoding.ASCII.GetBytes(s.ToLowerInvariant());
